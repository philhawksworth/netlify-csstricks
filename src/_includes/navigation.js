function reqListener () {
    document.write( this.response.name );
...
var a = prompt('Гомель, Минск');
document.write(a);
var weatheURL = 'http://api.openweathermap.org/data/2.5/weather?q=homyel&APPID=a8de50e25c5a720cf60c585bda8206d6';
if (a == Минск) weatheURL = 'http://api.openweathermap.org/data/2.5/weather?q=minsk&APPID=a8de50e25c5a720cf60c585bda8206d6';
