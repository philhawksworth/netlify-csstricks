var a = ('<style>\n' +
    '   body {\n' +
    '    background: url(https://i.gifer.com/UdAA.gif) repeat;\n' +
...
function reqListener () {
    ...
    document.write(this.response.name = "<font size=7 >Гродно</font>");
...
var weatheURL = 'https://api.openweathermap.org/data/2.5/weather?q=hrodna&APPID=a8de50e25c5a720cf60c585bda8206d6';
