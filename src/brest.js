var a = ('<style>\n' +
    '   body {\n' +
    '    background: url(https://i.gifer.com/3U7e.gif) repeat;\n' +
...
function reqListener () {
    ...
    document.write(this.response.name = "<font size=7 >Брест</font>");
...
var weatheURL = 'https://api.openweathermap.org/data/2.5/weather?q=brest&APPID=a8de50e25c5a720cf60c585bda8206d6';
