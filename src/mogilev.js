var a = ('<style>\n' +
    '   body {\n' +
    '    background: url(https://i.gifer.com/Cbd.gif) repeat;\n' +
...
function reqListener () {
    ...
    document.write(this.response.name = "<font size=7 >Могилев</font>");
    document.write('<br><br><font size=5 >',parseInt(this.response.main.temp - 273) + ' °C','</font>');
...
var weatheURL = 'https://api.openweathermap.org/data/2.5/weather?q=mahilyow&APPID=a8de50e25c5a720cf60c585bda8206d6';
