...
function reqListener () {
    ...
    else if (this.response.weather[(0)].main == 'Fog')   document.write('<br><br><font size=6 face=\'Calibri\'><span style="color:rgba(41,41,41,0.54)">Сильный туман</span></font></center></b>');
}
